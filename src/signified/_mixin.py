...
class _ReactiveNamespace[T]:
    ...
    @overload
    def where[A, B, C: protocols._Truthy](
        self: _ReactiveNamespace[C], a: HasValue[A], b: HasValue[B]
    ) -> Computed[A]: ...

    @overload
    def where[A, B, C: protocols._Falsy](
        self: _ReactiveNamespace[C], a: HasValue[A], b: HasValue[B]
    ) -> Computed[B]: ...
    ...
    @overload
    def as_bool[C: protocols._Truthy](self: _ReactiveNamespace[C]) -> Computed[Literal[True]]: ...

    @overload
    def as_bool[C: protocols._Falsy](self: _ReactiveNamespace[C]) -> Computed[Literal[False]]: ...
...
class _ReactiveMixIn[T]:
    ...
    def __abs__[R](self: protocols._ReactiveOf[SupportsAbs[R]]) -> Computed[R]:
    ...
    @overload
    def __round__[R](self: protocols._ReactiveOf[SupportsRound[R]], ndigits: None = None) -> Computed[int]: ...

    @overload
    def __round__[R](self: protocols._ReactiveOf[SupportsRound[R]], ndigits: int) -> Computed[R]: ...

    def __round__[R](
        self: protocols._ReactiveOf[SupportsRound[R]], ndigits: int | None = None
    ) -> Computed[int] | Computed[R]:
    ...
    @overload
    def __ceil__[R](self: protocols._ReactiveOf[protocols._SupportsCeil[R]]) -> Computed[R]: ...

    @overload
    def __ceil__(self: protocols._ReactiveOf[SupportsFloat | SupportsIndex]) -> Computed[int]: ...
    ...
    @overload
    def __floor__[R](self: protocols._ReactiveOf[protocols._SupportsFloor[R]]) -> Computed[R]: ...

    @overload
    def __floor__(self: protocols._ReactiveOf[SupportsFloat | SupportsIndex]) -> Computed[int]: ...
    ...
    def __invert__[R](self: protocols._ReactiveOf[protocols._SupportsInvert[R]]) -> Computed[R]:
    ...
    def __neg__[R](self: protocols._ReactiveOf[protocols._SupportsNeg[R]]) -> Computed[R]:
    ...
    def __pos__[R](self: protocols._ReactiveOf[protocols._SupportsPos[R]]) -> Computed[R]:
    ...
    def __trunc__[R](self: protocols._ReactiveOf[protocols._SupportsTrunc[R]]) -> Computed[R]:
    ...
    @overload
    def __add__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __add__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsAdd[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __add__[R](self, other: protocols._ReactiveOf[protocols._SupportsRadd[T, R]]) -> Computed[R]: ...

    @overload
    def __add__[Y, R](self: protocols._ReactiveOf[protocols._SupportsAdd[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __add__[R](self, other: protocols._SupportsRadd[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __and__(self: "_ReactiveMixIn[int]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __and__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsAnd[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __and__[R](self, other: protocols._ReactiveOf[protocols._SupportsRand[T, R]]) -> Computed[R]: ...

    @overload
    def __and__[Y, R](self: protocols._ReactiveOf[protocols._SupportsAnd[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __and__[R](self, other: protocols._SupportsRand[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __floordiv__(self: "_ReactiveMixIn[float]", other: protocols._FloatLike) -> Computed[float]: ...

    @overload
    def __floordiv__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsFloordiv[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __floordiv__[R](self, other: protocols._ReactiveOf[protocols._SupportsRfloordiv[T, R]]) -> Computed[R]: ...

    @overload
    def __floordiv__[Y, R](self: protocols._ReactiveOf[protocols._SupportsFloordiv[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __floordiv__[R](self, other: protocols._SupportsRfloordiv[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __ge__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsGe[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __ge__[R](self, other: protocols._ReactiveOf[protocols._SupportsLe[T, R]]) -> Computed[R]: ...

    @overload
    def __ge__[Y, R](self: protocols._ReactiveOf[protocols._SupportsGe[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __ge__[R](self, other: protocols._SupportsLe[T, R]) -> Computed[R]: ...

    def __ge__(self, other: Any) -> Computed[Any]:
    ...
    @overload
    def __gt__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsGt[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __gt__[R](self, other: protocols._ReactiveOf[protocols._SupportsLt[T, R]]) -> Computed[R]: ...

    @overload
    def __gt__[Y, R](self: protocols._ReactiveOf[protocols._SupportsGt[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __gt__[R](self, other: protocols._SupportsLt[T, R]) -> Computed[R]: ...

    def __gt__(self, other: Any) -> Computed[Any]:
    ...
    @overload
    def __le__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsLe[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __le__[R](self, other: protocols._ReactiveOf[protocols._SupportsGe[T, R]]) -> Computed[R]: ...

    @overload
    def __le__[Y, R](self: protocols._ReactiveOf[protocols._SupportsLe[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __le__[R](self, other: protocols._SupportsGe[T, R]) -> Computed[R]: ...

    def __le__(self, other: Any) -> Computed[Any]:
    ...
    @overload
    def __lt__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsLt[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __lt__[R](self, other: protocols._ReactiveOf[protocols._SupportsGt[T, R]]) -> Computed[R]: ...

    @overload
    def __lt__[Y, R](self: protocols._ReactiveOf[protocols._SupportsLt[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __lt__[R](self, other: protocols._SupportsGt[T, R]) -> Computed[R]: ...

    def __lt__(self, other: Any) -> Computed[Any]:
    ...
    @overload
    def __lshift__(self: "_ReactiveMixIn[int] | _ReactiveMixIn[bool]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __lshift__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsLshift[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __lshift__[R](self, other: protocols._ReactiveOf[protocols._SupportsRlshift[T, R]]) -> Computed[R]: ...

    @overload
    def __lshift__[Y, R](self: protocols._ReactiveOf[protocols._SupportsLshift[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __lshift__[R](self, other: protocols._SupportsRlshift[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __matmul__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsMatmul[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __matmul__[R](self, other: protocols._ReactiveOf[protocols._SupportsRmatmul[T, R]]) -> Computed[R]: ...

    @overload
    def __matmul__[Y, R](self: protocols._ReactiveOf[protocols._SupportsMatmul[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __matmul__[R](self, other: protocols._SupportsRmatmul[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __mod__(self: "_ReactiveMixIn[float]", other: protocols._FloatLike) -> Computed[float]: ...

    @overload
    def __mod__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsMod[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __mod__[R](self, other: protocols._ReactiveOf[protocols._SupportsRmod[T, R]]) -> Computed[R]: ...

    @overload
    def __mod__[Y, R](self: protocols._ReactiveOf[protocols._SupportsMod[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __mod__[R](self, other: protocols._SupportsRmod[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __mul__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...
    ...
    @overload
    def __mul__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsMul[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __mul__[R](self, other: protocols._ReactiveOf[protocols._SupportsRmul[T, R]]) -> Computed[R]: ...

    @overload
    def __mul__[Y, R](self: protocols._ReactiveOf[protocols._SupportsMul[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __mul__[R](self, other: protocols._SupportsRmul[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __or__(self: "_ReactiveMixIn[int]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __or__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsOr[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __or__[R](self, other: protocols._ReactiveOf[protocols._SupportsRor[T, R]]) -> Computed[R]: ...

    @overload
    def __or__[Y, R](self: protocols._ReactiveOf[protocols._SupportsOr[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __or__[R](self, other: protocols._SupportsRor[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __rshift__(self: "_ReactiveMixIn[int] | _ReactiveMixIn[bool]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __rshift__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRshift[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rshift__[R](self, other: protocols._ReactiveOf[protocols._SupportsRrshift[T, R]]) -> Computed[R]: ...

    @overload
    def __rshift__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRshift[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __rshift__[R](self, other: protocols._SupportsRrshift[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __pow__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __pow__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsPow[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __pow__[R](self, other: protocols._ReactiveOf[protocols._SupportsRpow[T, R]]) -> Computed[R]: ...

    @overload
    def __pow__[Y, R](self: protocols._ReactiveOf[protocols._SupportsPow[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __pow__[R](self, other: protocols._SupportsRpow[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __sub__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...
    ...
    @overload
    def __sub__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsSub[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __sub__[R](self, other: protocols._ReactiveOf[protocols._SupportsRsub[T, R]]) -> Computed[R]: ...

    @overload
    def __sub__[Y, R](self: protocols._ReactiveOf[protocols._SupportsSub[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __sub__[R](self, other: protocols._SupportsRsub[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __truediv__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __truediv__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsTruediv[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __truediv__[R](self, other: protocols._ReactiveOf[protocols._SupportsRtruediv[T, R]]) -> Computed[R]: ...

    @overload
    def __truediv__[Y, R](self: protocols._ReactiveOf[protocols._SupportsTruediv[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __truediv__[R](self, other: protocols._SupportsRtruediv[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __xor__(self: "_ReactiveMixIn[int]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __xor__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsXor[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __xor__[R](self, other: protocols._ReactiveOf[protocols._SupportsRxor[T, R]]) -> Computed[R]: ...

    @overload
    def __xor__[Y, R](self: protocols._ReactiveOf[protocols._SupportsXor[Y, R]], other: Y) -> Computed[R]: ...

    @overload
    def __xor__[R](self, other: protocols._SupportsRxor[T, R]) -> Computed[R]: ...
    ...
    @overload
    def __radd__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __radd__[D: date](self: "_ReactiveMixIn[D]", other: HasValue[timedelta]) -> Computed[D]: ...

    @overload
    def __radd__[R](self, other: protocols._ReactiveOf[protocols._SupportsAdd[T, R]]) -> Computed[R]: ...

    @overload
    def __radd__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRadd[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __radd__[R](self, other: protocols._SupportsAdd[T, R]) -> Computed[R]: ...

    @overload
    def __radd__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRadd[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rand__(self: "_ReactiveMixIn[int]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __rand__[R](self, other: protocols._ReactiveOf[protocols._SupportsAnd[T, R]]) -> Computed[R]: ...

    @overload
    def __rand__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRand[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rand__[R](self, other: protocols._SupportsAnd[T, R]) -> Computed[R]: ...

    @overload
    def __rand__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRand[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rfloordiv__(self: "_ReactiveMixIn[float]", other: protocols._FloatLike) -> Computed[float]: ...

    @overload
    def __rfloordiv__[R](self, other: protocols._ReactiveOf[protocols._SupportsFloordiv[T, R]]) -> Computed[R]: ...

    @overload
    def __rfloordiv__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRfloordiv[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rfloordiv__[R](self, other: protocols._SupportsFloordiv[T, R]) -> Computed[R]: ...

    @overload
    def __rfloordiv__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRfloordiv[Y, R]], other: Y
    ) -> Computed[R]: ...
    ...
    @overload
    def __rlshift__(self: "_ReactiveMixIn[int] | _ReactiveMixIn[bool]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __rlshift__[R](self, other: protocols._ReactiveOf[protocols._SupportsLshift[T, R]]) -> Computed[R]: ...

    @overload
    def __rlshift__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRlshift[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rlshift__[R](self, other: protocols._SupportsLshift[T, R]) -> Computed[R]: ...

    @overload
    def __rlshift__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRlshift[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rmatmul__[R](self, other: protocols._ReactiveOf[protocols._SupportsMatmul[T, R]]) -> Computed[R]: ...

    @overload
    def __rmatmul__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRmatmul[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rmatmul__[R](self, other: protocols._SupportsMatmul[T, R]) -> Computed[R]: ...

    @overload
    def __rmatmul__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRmatmul[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rmod__(self: "_ReactiveMixIn[float]", other: protocols._FloatLike) -> Computed[float]: ...

    @overload
    def __rmod__[R](self, other: protocols._ReactiveOf[protocols._SupportsMod[T, R]]) -> Computed[R]: ...

    @overload
    def __rmod__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRmod[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rmod__[R](self, other: protocols._SupportsMod[T, R]) -> Computed[R]: ...

    @overload
    def __rmod__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRmod[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rmul__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...
    ...
    @overload
    def __rmul__[R](self, other: protocols._ReactiveOf[protocols._SupportsMul[T, R]]) -> Computed[R]: ...

    @overload
    def __rmul__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRmul[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rmul__[R](self, other: protocols._SupportsMul[T, R]) -> Computed[R]: ...

    @overload
    def __rmul__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRmul[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __ror__(self: "_ReactiveMixIn[int]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __ror__[R](self, other: protocols._ReactiveOf[protocols._SupportsOr[T, R]]) -> Computed[R]: ...

    @overload
    def __ror__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRor[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __ror__[R](self, other: protocols._SupportsOr[T, R]) -> Computed[R]: ...

    @overload
    def __ror__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRor[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rpow__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __rpow__[R](self, other: protocols._ReactiveOf[protocols._SupportsPow[T, R]]) -> Computed[R]: ...

    @overload
    def __rpow__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRpow[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rpow__[R](self, other: protocols._SupportsPow[T, R]) -> Computed[R]: ...

    @overload
    def __rpow__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRpow[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rrshift__(self: "_ReactiveMixIn[int] | _ReactiveMixIn[bool]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __rrshift__[R](self, other: protocols._ReactiveOf[protocols._SupportsRshift[T, R]]) -> Computed[R]: ...

    @overload
    def __rrshift__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRrshift[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rrshift__[R](self, other: protocols._SupportsRshift[T, R]) -> Computed[R]: ...

    @overload
    def __rrshift__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRrshift[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rsub__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __rsub__[R](self, other: protocols._ReactiveOf[protocols._SupportsSub[T, R]]) -> Computed[R]: ...

    @overload
    def __rsub__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRsub[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rsub__[R](self, other: protocols._SupportsSub[T, R]) -> Computed[R]: ...

    @overload
    def __rsub__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRsub[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rtruediv__(self: "_ReactiveMixIn[complex]", other: protocols._ComplexLike) -> Computed[complex]: ...

    @overload
    def __rtruediv__[R](self, other: protocols._ReactiveOf[protocols._SupportsTruediv[T, R]]) -> Computed[R]: ...

    @overload
    def __rtruediv__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRtruediv[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rtruediv__[R](self, other: protocols._SupportsTruediv[T, R]) -> Computed[R]: ...

    @overload
    def __rtruediv__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRtruediv[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __rxor__(self: "_ReactiveMixIn[int]", other: protocols._IntLike) -> Computed[int]: ...

    @overload
    def __rxor__[R](self, other: protocols._ReactiveOf[protocols._SupportsXor[T, R]]) -> Computed[R]: ...

    @overload
    def __rxor__[Y, R](
        self: protocols._ReactiveOf[protocols._SupportsRxor[Y, R]], other: protocols._ReactiveOf[Y]
    ) -> Computed[R]: ...

    @overload
    def __rxor__[R](self, other: protocols._SupportsXor[T, R]) -> Computed[R]: ...

    @overload
    def __rxor__[Y, R](self: protocols._ReactiveOf[protocols._SupportsRxor[Y, R]], other: Y) -> Computed[R]: ...
    ...
    @overload
    def __getitem__[V](self: "_ReactiveMixIn[list[V]]", key: protocols._IndexLike) -> Computed[V]: ...

    @overload
    def __getitem__[V](self: "_ReactiveMixIn[tuple[V, ...]]", key: protocols._IndexLike) -> Computed[V]: ...

    @overload
    def __getitem__(self: "_ReactiveMixIn[str]", key: protocols._IndexLike) -> Computed[str]: ...
