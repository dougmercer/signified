...
Add `deep_unref.register(Type)` for custom containers. Preserve shared references,
report cycles and resolved key/member collisions, and retain NumPy shape/dtype.
