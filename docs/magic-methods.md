...
| [`__setitem__`](api.md#signified._mixin._ReactiveMixIn.__setitem__) | `#!pycon >>> from signified import Signal`<br>`#!pycon >>> nums = Signal([1, 2, 3])`<br>`#!pycon >>> first = nums[0]`<br>`#!pycon >>> nums[0] = 10`<br>`#!pycon >>> first`<br>`#!pycon <10>` | Works for wrapped `list`/`dict` item updates. |
